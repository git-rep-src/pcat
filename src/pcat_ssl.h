...
#define PCAT_CA_CERTS_FILE "ca-bundle.crt"
...
enum {
    PCAT_SSL_HANDSHAKE_COMPLETED      = 0,
    PCAT_SSL_HANDSHAKE_PENDING_READ   = 1,
    PCAT_SSL_HANDSHAKE_PENDING_WRITE  = 2,
    PCAT_SSL_HANDSHAKE_FAILED         = 3
};
